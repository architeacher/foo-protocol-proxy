...
replaceInFile '{{GO_VERSION}}' $GO_VERSION $DOCKER_COMPOSE_FILE
replaceInFile '{{PKG_NAMESPACE}}' $PKG_NAMESPACE $DOCKER_COMPOSE_FILE
...
replaceInFile '{{ENV_FILE_PATH}}' $ENV_FILE_PATH $DOCKER_COMPOSE_FILE
replaceInFile '{{HEALTH_PORT}}' $HEALTH_PORT $DOCKER_COMPOSE_FILE
