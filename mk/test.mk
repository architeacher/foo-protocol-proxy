test: unit unit-short unit-with-race-cover bench integration ## to setup the external used tools.
...
unit-with-race-cover: ## to run unit tests with race conditions coverage.
