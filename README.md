...
<summary>🔥 Todo:</summary>
   <ul>
       <li>
        Resource pooling for connections, to enable reuse of a limited
        number of open connections with the server, and to requeue unused ones.
        </li>
       <li>Performance and memory optimization.</li>
       <li>More unit tests coverage.</li>
       <li>Refactoring.</li>
   </ul>
</details>
...
Please refer to [CONTRIBUTING.md](https://github.com/ahmedkamals/foo-protocol-proxy/blob/master/CONTRIBUTING.md) file.
...
Foo protocol proxy released under MIT license, refer [LICENSE](https://github.com/ahmedkamals/foo-protocol-proxy/blob/master/LICENSE) file.  
...
[22]: https://github.com/ahmedkamals "Author"
